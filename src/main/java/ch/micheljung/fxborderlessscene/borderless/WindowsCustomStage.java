...
class WindowsCustomStage {
  ...
  WindowsCustomStage(WindowController windowController, boolean blurBehind, boolean useAcrylic) {
    ...
    user32Ex.SetWindowLongPtr(hwnd, GWL_WNDPROC,
      new DecorationWindowProcedure(windowController, defaultWindowsProcedure));
